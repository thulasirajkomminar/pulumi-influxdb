...
replace github.com/thulasirajkomminar/terraform-provider-influxdb/v2/shim => ./shim

require (
	github.com/pulumi/pulumi-terraform-bridge/v3 v3.110.0
	github.com/thulasirajkomminar/terraform-provider-influxdb/v2/shim v0.0.0
)
...
require (
	...
	github.com/thulasirajkomminar/terraform-provider-influxdb/v2 v2.0.0 // indirect
